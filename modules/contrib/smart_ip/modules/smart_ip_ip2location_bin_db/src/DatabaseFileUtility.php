...
class DatabaseFileUtility extends DatabaseFileUtilityBase {
   ...
   * @param int|string $ipVersion
   *   IP version: IPv4 or IPv6.
   *
   * @return string
   *   Returns the IP2Location binary database filename.
   */
  public static function getFilename(string $version = Ip2locationBinDb::LITE_VERSION, string $edition = Ip2locationBinDb::DEFAULT_EDITION, int|string $ipVersion = Ip2locationBinDb::IPV4_VERSION): string {
   ...
   */
  public static function downloadDatabaseFile(int $ipVersion) {
