...
class DatabaseFileUtility extends DatabaseFileUtilityBase {
   ...
   * @return string
   */
  public static function getFilename(string $version = MaxmindGeoip2BinDb::LITE_VERSION, string $edition = MaxmindGeoip2BinDb::CITY_EDITION, bool $withExt = TRUE): string {
